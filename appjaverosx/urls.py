...
urlpatterns = patterns('',
    ...
    url(r'cart_remove/(\d+)/$', 'market.views.remove_from_cart', name='eliminar_carrito'),
    ...
    url(r'^pedidos/detalle/(\d+)/$', 'market.views.detalle_pedido_view', name='ver_detalle_pedido'),
    ...
    url(r'cart_remove/(\d+)/$', 'market.views.get_cart', name='ver_carrito'),
